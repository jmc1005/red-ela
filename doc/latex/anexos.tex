...
\definecolor{darkblue}{RGB}{11, 24, 115}
...
\newcommand{\nombre}{Javier Martín Castro}
\newcommand{\nomtutor}{Pedro Renedo Fernández}

% Datos de portada
\title{RedELA \\Documentación Técnica}
\author{Javier Martín Castro}
