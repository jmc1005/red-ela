...
\imagenTam{workflow-java}{Instalar versión java}{.5}

2. Crear nuestro fichero dotenv con los secrets
\imagen{workflow-dotenv}{Crear fichero dotenv}

3. Compilar y construir la web
\imagen{workflow-build}{Compilar y generar web}

4. Desplegar en el hosting de firebase
\imagen{workflow-deploy}{Desplegar en el hosting de Firebase}
