...
\imagenTam{mvvm-clean-arquitecture}{mvvm}{.7}
...
\imagenTam{flutter-so}{Plataforma desarrollo}{.7}
...
\imagenTam{flutter-doctor-command}{Comprobación correcta instalación Flutter}{.7}
...
\imagenTam{flutter-extension}{Añadir Flutter a Visual Studio Code}{.7}
...
\imagenTam{flutter-command-palette}{Paleta de comandos VS Code}{.7}
...
\imagenTam{flutter-encrypt-secure-random}{Encrypt secure random}{.7}
...
\imagenTam{firebase-agregar-proyecto}{Agregar proyecto}{.7}
\item Introduciremos el nombre del proyecto. Pulsaremos \textbf{continuar}
\imagenTam{firebase-nombre-proyecto}{Nombre proyecto}{.7}
...
\imagenTam{github-secrets}{Secrets and variables}{.7}
...
\imagenTam{github-repository-secrets}{Respository secrets}{.7}
...
1. Instalar la versión de java
\imagenTam{workflow-java}{Instalar versión java}{.7}

2. Crear nuestro fichero dotenv con los secrets
\imagenTam{workflow-dotenv}{Crear fichero dotenv}{.7}

3. Compilar y construir la web
\imagenTam{workflow-build}{Compilar y generar web}{.7}

4. Desplegar en el hosting de firebase
\imagenTam{workflow-deploy}{Desplegar en el hosting de Firebase}{.7}
...
\imagenTam{google-play-nueva-version} {Nueva versión}{.9}
	\item Subir el bundle generado y actualizar la versión, por ejemplo a 4 (1.0.4)
\imagenTam{google-play-subir-bundle}{Subir bundle}{.9}
\imagenTam{google-play-detalle-version}{Detalle versión}{.9}
\end{enumerate}
...
\imagenTam{flutter-device}{Seleccionar dispositivo}{.8}
...
\imagenTam{flutter-test-ok}{Test OK}{.8}
